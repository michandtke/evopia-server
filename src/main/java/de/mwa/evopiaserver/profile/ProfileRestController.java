...
//
//    public ProfileRestController(UserRepositoryNew userRepository,
...
//        int profileChannelsSaved =
//                profileChannelService.upsert(profile.getId(), newProfile.getProfileChannels());
//        return new GenericResponse("success: " + saved + " | With " + profileChannelsSaved + " profileChannels.");
//    }
//
//    @GetMapping("/profile")
